...
Queste vengono messe insieme da un programma che chiamiamo *linker* da cui viene emesso il file, che per essere eseguito deve entrare in un *loader*.

Questo processo descritto è specifico di C, molti linguaggi hanno un processo simile ma non necessariamente lo stesso (esempio: python che è un linguaggio non compilato, ma interpretato).