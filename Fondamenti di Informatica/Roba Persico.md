...
## Cosa facciamo in sto corso?
In questo corso non Non faremo manualmente la catena di [[Traduzione del codice C]] ma useremo un IDE, cioè una suite di programmazione in cui ho tutte le funzioni della catena di traduzione.
è importante non dimenticare la catena di operazioni necessarie dello scrivere il codice.
