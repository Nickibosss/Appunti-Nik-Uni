...
Si possono applicare a un *qualsiasi tipo di dato* e restituiscono un [[Tipi di variabili|booleano]] uguale a `true` se la relazione è *verificata* e `false` se è *non verificata*.
